 ...
 * Class for vector wimages manipulations.
 * @constructor
...
function(code, multiMap){
  return 'jquery-jvectormap-data-'+
         code.toLowerCase()+'-'+
         multiMap.defaultProjection+'-en.wjs';
}
</pre>
 */
...
jvm.MultiMap.defaultParams = {
  ...
  mapUrlByCode: function(code, multiMap){
    return 'jquery-jvectormap-data-'+code.toLowerCase()+'-'+multiMap.defaultProjection+'-en.wjs';
  }
}